...
//   }),
//   telefono: Joi.string().pattern(/^\d{9}$/).required().messages({
//     "string.base": "El campo 'teléfono' debe ser un texto numérico.",
//     "string.pattern.base": "El campo 'teléfono' debe tener exactamente 9 dígitos.",
